...
(let ((class '((class color) (min-colors 89)))
      ...
      (grey-3 "#222")      (grey-10 "#888")     (grey-20 "#666")
      (white "#fff")       (butter-0 "#ffec8b")
  ...
  (custom-theme-set-faces
   ...
   `(line-number-major-tick   ((,class (:foreground ,grey-3 :background "grey75"))))
   `(line-number-minor-tick   ((,class (:foreground ,grey-3 :background "grey75"))))
   ;; Highlighting faces
   ...
   `(gnus-group-news-low-empty ((,class (:foreground ,blue-2))))
   ...
   `(gnus-summary-high-read    ((,class (:foreground ,cham-3))))
   `(gnus-summary-low-read     ((,class (:foreground ,cham-3))))
   `(gnus-summary-normal-read  ((,class (:foreground ,cham-3))))
   `(gnus-summary-normal-ticked ((,class (:foreground ,plum-0))))
   ;; Message faces
   ...
   ;; diff faces
   `(diff-removed        ((,class (:foreground ,alum-5 :background "#ffdddd"))))
   `(diff-refine-added   ((,class (:foreground ,alum-5 :background "#aaffaa"))))
   `(diff-added          ((,class (:foreground ,alum-5 :background "#ddffdd"))))
