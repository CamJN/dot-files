...
;; https://raw.githubusercontent.com/emacs-mirror/emacs/refs/heads/master/etc/themes/tango-dark-theme.el
...
(let ((class '((class color) (min-colors 89)))
      ...
      (cyan-1   "#34e2e2") (cyan-2   "#06989a") (cyan-3   "#2e3436")
      (orange-1 "#fcaf3e") (orange-2 "#f57900") (orange-3 "#ce5c00")
      (red-0    "#ff4b4b") (red-1    "#ef2929") (red-2    "#cc0000") (red-3    "#a40000") (red-4    "#ffdddd")
      (blue-0   "#8cc4ff") (blue-1   "#729fcf") (blue-1.5 "#5fafff") (blue-2   "#3465a4") (blue-3   "#204a87")
      (plum-0   "#e9b2e3") (plum-1   "#e090d7") (plum-2   "#75507b") (plum-3   "#5c3566") (plum-4   "#af87ff")
      (butter-0 "#ffec8b") (butter-1 "#fce94f") (butter-2 "#edd400") (butter-3 "#c4a000") (butter-4 "#c0c000")
      (cham-0   "#b4fa70") (cham-1   "#8ae234") (cham-2   "#73d216") (cham-3   "#4e9a06") (cham-4   "#afffaf") (cham-5   "#ddffdd")
      (alum-1   "#eeeeec") (alum-2   "#d3d7cf") (alum-3   "#babdb6") (alum-4   "#888a85") (alum-5   "#555753") (alum-5.5 "#41423f") (alum-6 "#1c1c1c") (alum-7 "#212526")
      (grey-3   "#222")    (grey-10  "#888")    (grey-20  "#666")    (grey-75  "#444")
)
  ...
  (custom-theme-set-faces
   ...
   `(match                    ((,class (:foreground ,alum-1))))
   `(widget-field             ((,class (:foreground ,alum-6  :background ,butter-1))))
   `(shadow                   ((,class (:foreground ,grey-20))))
   `(header-line              ((,class (:background ,grey-10))))
   `(cursor                   ((,class (:background ,butter-1))))
   `(log-view-message         ((,class (:foreground ,grey-10))))
   `(completions-common-part  ((,class (:foreground ,blue-1))))
   `(edmacro-label            ((,class (:foreground ,blue-1))))
   ;; line-number faces
   `(line-number              ((,class (:foreground ,grey-10))))
   `(line-number-current-line ((,class (:foreground ,white))))
   `(line-number-major-tick   ((,class (:foreground ,grey-3 :background ,grey-75))))
   `(line-number-minor-tick   ((,class (:foreground ,grey-3 :background ,grey-75))))
   ;; Highlighting faces
   ...
   `(trailing-whitespace ((,class (:background ,red-0))))
   ;; Mode line faces
   `(mode-line                  ((,class (:box (:line-width -1 :style released-button) :background ,alum-2 :foreground ,alum-6))))
   `(mode-line-inactive         ((,class (:box (:line-width -1 :style released-button) :background ,alum-5 :foreground ,alum-1))))
   ...
   `(minibuffer-nonselected ((,class (:foreground ,alum-5 :background ,cham-4))))
   ...
   `(gnus-header-content       ((,class (:foreground ,butter-3 :weight normal))))
   ...
   `(ediff-fine-diff-B ((,class (:background ,red-0))))
   `(ediff-even-diff-B ((,class (:background ,alum-5.5))))
   `(ediff-odd-diff-B ((,class (:background ,alum-5.5))))
   ;; diff faces
   `(diff-removed        ((,class (:foreground ,alum-5 :background ,red-4))))
   `(diff-refine-added   ((,class (:foreground ,alum-5 :background ,cham-4))))
   `(diff-added          ((,class (:foreground ,alum-5 :background ,cham-5))))
   ;; `(diff-refine-changed ((,class (:foreground ,alum-1))))
   ;; Flyspell faces
   `(flyspell-duplicate ((,class (:underline ,orange-1))))
   `(flyspell-incorrect ((,class (:underline ,red-1 :foreground ,red-1))))
   ;; ido
   `(ido-subdir ((,class (:foreground ,blue-1))))
   ;; Realgud
   `(realgud-overlay-arrow1  ((,class (:foreground ,cham-4))))
   ...
   `(realgud-bp-line-enabled-face  ((,class (:underline ,red-2))))
   ...
   ;; Eglot
   `(eglot-diagnostic-tag-unnecessary-face ((,class (:foreground ,red-1 :strike-through t))))
   `(eglot-inlay-hint-face                 ((,class (:foreground ,blue-1))))
   ;; ibuffer
   `(ibuffer-locked-buffer                 ((,class (:foreground ,plum-1))))
   ;; typescript-treesitter
   `(typescript-ts-jsx-attribute-face      ((,class (:inherit font-lock-property-use-face))))
   ;; company (these were red)
   `(company-tooltip-common           ((,class (:foreground ,blue-2))))
   `(company-tooltip-common-selection ((,class (:foreground ,blue-1))))
   `(company-echo-common              ((,class (:foreground ,blue-1))))
   `(company-tooltip-annotation       ((,class (:foreground ,blue-1))))
   `(company-tooltip-selection        ((,class (:background ,blue-1))))
   ;; custom
   `(custom-comment-tag                    ((,class (:foreground ,blue-3))))
   `(custom-group-tag                      ((,class (:foreground ,blue-1))))
   `(custom-state                          ((,class (:foreground ,cham-3))))
   `(custom-variable-obsolete              ((,class (:foreground ,blue-1))))
   `(custom-variable-tag                   ((,class (:foreground ,blue-1))))
   ;; GUI
